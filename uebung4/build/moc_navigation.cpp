...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Navigation_t, stringdata) + ofs \
...
const QMetaObject Navigation::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Navigation.data,
      qt_meta_data_Navigation,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Navigation.stringdata))
