...
GLViewer::GLViewer(AbstractPainter *painter, const QSurfaceFormat & defaultFormat, QWidget *parent)
    : QWidget(parent)
    , m_painter(painter)
    , m_canvas(0)
{
...
void GLViewer::setup(const QSurfaceFormat & defaultFormat)
{
    QSurfaceFormat format(defaultFormat);
