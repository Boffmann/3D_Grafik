...
{
    mousePressEventR(e);
    emit mousePressEventS(e);
}

void ImageView::mousePressEventR(QMouseEvent *e)
{
...
{
    mouseMoveEventR(e);
    emit mouseMoveEventS(e);
}

void ImageView::mouseMoveEventR(QMouseEvent *e)
{
    if (m_mode == MODE_PAN)
    {
...
{
    mouseReleaseEventR(e);
    emit mouseReleaseEventS(e);
}

void ImageView::mouseReleaseEventR(QMouseEvent *e)
{
...
void ImageView::wheelEventR(QWheelEvent *e)
{
    QSize sz = size();
...
void ImageView::synchronize(ImageView *share)
{
    connect(this, SIGNAL(mousePressEventS(QMouseEvent*)), share, SLOT(mousePressEventR(QMouseEvent*)));
    connect(this, SIGNAL(mouseReleaseEventS(QMouseEvent*)), share, SLOT(mouseReleaseEventR(QMouseEvent*)));
    connect(this, SIGNAL(mouseMoveEventS(QMouseEvent*)), share, SLOT(mouseMoveEventR(QMouseEvent*)));
    connect(this, SIGNAL(wheelEventS(QWheelEvent*)), share, SLOT(wheelEventR(QWheelEvent*)));
}

void ImageView::desynchronize(ImageView *share)
{
    disconnect(this, SIGNAL(mousePressEventS(QMouseEvent*)), share, SLOT(mousePressEventR(QMouseEvent*)));
    disconnect(this, SIGNAL(mouseReleaseEventS(QMouseEvent*)), share, SLOT(mouseReleaseEventR(QMouseEvent*)));
    disconnect(this, SIGNAL(mouseMoveEventS(QMouseEvent*)), share, SLOT(mouseMoveEventR(QMouseEvent*)));
    disconnect(this, SIGNAL(wheelEventS(QWheelEvent*)), share, SLOT(wheelEventR(QWheelEvent*)));
}
